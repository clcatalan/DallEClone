...
const CreatePost = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if(form.prompt && form.photo) {
      ...
      alert('add prompt and generate image first')
    }
  }
  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[16px] max-w-[500px]">Create visually stunning images with Dall-E AI and share them with the community</p>
      </div>
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="mt-10">
          ...
          >Once you have generated your image, you could share it with the community!</p>
          <button
            type="submit"
